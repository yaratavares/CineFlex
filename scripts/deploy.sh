...
echo "----------------------------------------"
echo "Planning..."
echo "terraform plan -var=domain=$DOMAIN -var=environment=$ENVIRONMENT -out=plan.tfout"
terraform plan -var="domain=$DOMAIN" -var=environment=$ENVIRONMENT -out="plan.tfout"
echo "----------------------------------------"
echo "Applying..."
